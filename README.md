...
#### 2. Static Memory Pool / Slab Allocator
...
#### 3. Hierarchical State Machine (HSM) Framework
...
#### 7. Template GPIO Abstraction Layer
...
#### 8. Priority Task Scheduler (bare-metal simulation)
...
#### 9. Publish-Subscribe Event Bus (static)
